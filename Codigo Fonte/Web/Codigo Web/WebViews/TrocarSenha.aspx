<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrocarSenha.aspx.cs" Inherits="Web.WebViews.TrocarSenha" %>
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-9467">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                <div class="u-layout">
                    <div class="u-layout-row">
                        ...
                        <form id="form1" runat="server">
                            <table cellspacing="6" style="text-align: left;" class="auto-style1" >
                                <tr>
                                    <td class="auto-style2">
                                        <asp:Label ID="lblEmail" runat="server" Text="E-mail" Font-Size="Large"></asp:Label>
                                    </td>
                                    <td></td>
                                    <td>
                                            <asp:TextBox ID="txtEmail" runat="server" CssClass="txtBox" Font-Size="Large" AutoPostBack="True" Width="200px"></asp:TextBox>
                                            <asp:Image ID="imgDisponivel" runat="server" Width="14px" />
                                    </td>
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label2" runat="server" Text="Nova Senha" Font-Bold="False" Font-Size="Large"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:TextBox ID="txtSenha" runat="server" CssClass="txtBox" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtSenha_TextChanged" TextMode="Password" Width="200px"></asp:TextBox>
                    </td>

                </tr>
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label3" runat="server" Text="Confirmar Senha" Font-Bold="False" Font-Size="Large"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                    <td>
                        <asp:TextBox ID="txtSenha1" runat="server" CssClass="txtBox" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtSenha1_TextChanged" TextMode="Password" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="10">
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Button ID="btnConfrimar" runat="server" Text="Confirmar" CssClass="btnLog" Font-Size="Large" ForeColor="White" OnClick="btnConfrimar_Click" Width="150px" />
                    </td>
                </tr>
                            </table>
                        </form>
